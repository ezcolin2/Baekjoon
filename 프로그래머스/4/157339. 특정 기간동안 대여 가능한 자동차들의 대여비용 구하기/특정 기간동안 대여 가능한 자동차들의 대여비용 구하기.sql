...
WITH CAR_TABLE AS (
	SELECT CAR_ID, A.CAR_TYPE, DAILY_FEE, DISCOUNT_RATE, ROUND(30*DAILY_FEE * (100-DISCOUNT_RATE)/100) AS DISCOUNTED_FEE FROM CAR_RENTAL_COMPANY_CAR AS A JOIN CAR_RENTAL_COMPANY_DISCOUNT_PLAN AS B ON A.CAR_TYPE = B.CAR_TYPE WHERE DURATION_TYPE = "30일 이상"
)
